...
class Pokemons {
    ...
    public static void selection() { // COMPARAÇÕES: n²
        for (int i = 0; i < arrayPokemos.size() - 1; i++) { // COMPARAÇÕES: "n" movimentações
            comparisons++;
            int menor = i;
    ...
    public static void generatorLog(long startTime, long endTime) {
        ...
        try {
            ...
            writer.write("Matrícula" + "\t" + "Tempo" + "\t" + "BigO" + "\t" + "Valor de Movimentações" + "\t" + "Valor de Comparações\n");
