...
void insertionColor(Pokemons *array, int n, int color, int h)
{
...
void shellsort(Pokemons *array, int n)
{
    int h = 1;
    ...
    do
    {
        ...
        {
            insertionColor(array, n, color, h);
        }
    } while (h != 1);
}
...
{
    char matricula[] = "863593_shellsort";
    char nomeArquivo[20];
